...
//   image: "https://i2-prod.mirror.co.uk/incoming/article1899080.ece/ALTERNATES/s615b/Tottenham-Hotspur-v-Sunderland-Premier-League.jpg",
//   tags:['sport'],
//   title: "Gareth Bale could take iconic former Tottenham shirt number on dramatic Spurs return",
...
export async function getAllArticles(){
  const articles = await db.collection('articles').get().then(querySnapshot => {
